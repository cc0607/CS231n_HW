...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        # outs['out1'],caches['cache1'] = out,cache
        # out,cache = affine_relu_forward(out,W2,b2)
        # outs['out2'],caches['cache2'] = out,cache
        # out,cache = affine_forward(out,W3,b3)
        # outs['out3'],caches['cache3'] = out,cache
        # scores = out
        ...
        # da = dscores
        # dx,dw,db = conv_relu_pool_backward(scores, caches['cache3'])
